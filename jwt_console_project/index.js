...
async function main() {
  ...
  let args = getArgs(accountInfo.apiAccountId, accountInfo.accessToken, accountInfo.basePath, req.body.email.req.body.name, req.body.ccemail, req.body.ccname);
...
app.post('/sendemail', async (req, res) => {
  try {
    ...
    req.body.email, req.body.name, req.body.ccemail, req.body.ccname);
    let envelopeId = signingViaEmail.sendEnvelope(args);
    console.log(envelopeId);
    res.sendFile(__dirname + "/success.html");
  }
  catch {
    res.send('<h1>Fail to sent email</h1>');
  }
})
